...
class AzureDevopsClient:
    ...
    def __init__(self, request_helper: RequestHelper):
        ...
        self.settings = Settings().AdoSettings
        self.request_helper = request_helper
        self.headers = {
            'Content-Type': 'application/json',
            'Authorization': f'Basic {self._encode_pat(self.settings.token)}'
        }
    ...
    def get_threads(self, pull_request_id: int) -> dict:
        ...
        request_url: str = self.request_helper.get_project_api_url(f'/git/repositories/{self.settings.repository_name}/pullrequests/{pull_request_id}/threads')
    ...
    def get_pull_requests(self, params: dict) -> dict:
        ...
        request_url: str = self.request_helper.get_project_api_url_with_params(f'/git/repositories/{self.settings.repository_name}/pullrequests', params)
        return self._send_request('GET', request_url)
